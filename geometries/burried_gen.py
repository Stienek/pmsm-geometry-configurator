...
def create(params):
    ...
    drawLabel((outer_radius - inset/2)*np.cos(np.deg2rad(45/2)), (outer_radius - inset/2)*np.sin(np.deg2rad(45/2)), material="50JN400", group=5)
    drawLabel((outer_radius - inset/2)*np.cos(np.deg2rad(45+45/2)), (outer_radius - inset/2)*np.sin(np.deg2rad(45+45/2)), material="50JN400", group=5)
